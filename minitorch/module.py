class Module:
    ...
    def named_parameters(self):
        ...
        """
        parent_dict = [
            (param_key, self._parameters[param_key]) for param_key in self._parameters
        ]

        for mod_key in self._modules:
            child_dict = self._modules[mod_key].named_parameters()
            for child_key, child_parameter in child_dict:
                parent_dict.append((mod_key + "." + child_key, child_parameter))
